...
public class HashTable {
	...
	public static void main(String[] args) {
		...
		// theFunc.inserir1(elementsToAdd, theFunc.theArray);
		...
		theFunc.inserir2(elementsToAdd2, theFunc.theArray);

		// Locate the value 660 in the Hash Table

		theFunc.EncontrarChave("660");
	...
	public void inserir1(String[] stringsForArray, String[] theArray) {
	...
	public void inserir2(String[] stringsForArray, String[] theArray) {
	...
	public String EncontrarChave(String key) {
